...
The  first 2 additive components explain 94.7\% of the variation in the data as shown by the coefficient of determination ($R^2$) values in table~\ref{table:stats}.
...
\begin{itemize}
  ...
  \item \input{test_1d/test_1d_1_short_description.tex} 

  \item \input{test_1d/test_1d_2_short_description.tex} 

  \item \input{test_1d/test_1d_3_short_description.tex} 
...
1 & 78.5 & 78.5 & 78.5 & 0.14 & 81.6\\

2 & 94.7 & 16.2 & 75.4 & 0.09 & 36.8\\

3 & 100.0 & 5.3 & 100.0 & 0.09 & 0.0\\
...
These statistics have revealed statistically significant discrepancies between the data and model in component 3.
...
\subsection{Component 1 : A very smooth monotonically decreasing function. This function applies until  391}

\input{test_1d/test_1d_1_description.tex}

This component explains 78.5\% of the total variance.
The addition of this component reduces the cross validated MAE by 81.6\% from 0.7 to 0.1.
...
\input{test_1d/test_1d_2_description.tex}

This component explains 75.4\% of the residual variance; this increases the total variance explained from 78.5\% to 94.7\%.
The addition of this component reduces the cross validated MAE by 36.84\% from 0.14 to 0.09.
...
\subsection{Component 3 : Uncorrelated noise with standard deviation increasing linearly away from  368. This function applies until  391}

\input{test_1d/test_1d_3_description.tex}

This component explains 100.0\% of the residual variance; this increases the total variance explained from 94.7\% to 100.0\%.
...
\input{test_1d/test_1d_1_extrap_description.tex}
...
\input{test_1d/test_1d_2_extrap_description.tex}
...
\input{test_1d/test_1d_3_extrap_description.tex}
...
1 & \textcolor{gray}{0.815} & \textcolor{gray}{0.580} & \textcolor{gray}{0.693} & \textcolor{gray}{0.500} & \textcolor{gray}{0.849} & \textcolor{gray}{0.241}\\

2 & \textcolor{gray}{0.794} & \textcolor{gray}{0.083} & \textcolor{gray}{0.342} & \textcolor{gray}{0.431} & \textcolor{gray}{0.729} & \textcolor{gray}{0.461}\\

3 & \textcolor{gray}{0.481} & \textcolor{gray}{0.513} & \textcolor{gray}{0.510} & \textcolor{gray}{0.493} & 0.015 & \textcolor{gray}{0.658}\\
...
\subsubsection{Component 3 : Uncorrelated noise with standard deviation increasing linearly away from  368. This function applies until  391}
...
\begin{itemize}
    ...
    \item The qq plot has an unexpectedly large positive deviation from equality ($x = y$). This discrepancy has an estimated $p$-value of 0.015.
\end{itemize}
...
\subsubsection{Component 1 : A very smooth monotonically decreasing function. This function applies until  391}
