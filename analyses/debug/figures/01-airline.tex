...
The full model explains 100.0\% of the variation in the data as shown by the coefficient of determination ($R^2$) values in table~\ref{table:stats}.
...
1 & 85.5 & 85.5 & 85.5 & 30.70 & 88.2\\

2 & 100.0 & 14.5 & 100.0 & 30.70 & 0.0\\
...
This component explains 85.5\% of the total variance.
The addition of this component reduces the cross validated MAE by 88.2\% from 259.5 to 30.7.
...
This component explains 100.0\% of the residual variance; this increases the total variance explained from 85.5\% to 100.0\%.
The addition of this component reduces the cross validated MAE by 0.00\% from 30.70 to 30.70.
...
1 & \textcolor{gray}{0.429} & \textcolor{gray}{0.698} & \textcolor{gray}{0.391} & \textcolor{gray}{0.364} & \textcolor{gray}{0.325} & \textcolor{gray}{0.743}\\

2 & \textbf{0.000} & \textcolor{gray}{0.140} & \textbf{1.000} & \textcolor{gray}{0.158} & \textcolor{gray}{0.123} & \textcolor{gray}{0.696}\\
...
\begin{itemize}
    ...
    \item The minimum value of the ACF is unexpectedly low. This discrepancy has an estimated $p$-value of \textbf{0.000}.
