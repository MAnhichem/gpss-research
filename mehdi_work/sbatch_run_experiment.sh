...
module purge
module load apps/anaconda2/5.2.0
#use conda activate to get the gpflow virtual environment
conda activate /users/anhichem/.conda/envs/env_gpss-research_barkla
#
#
echo =========================================================   
