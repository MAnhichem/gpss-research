...
\title{An automatic report for the dataset : test_1d-depth-5}
...
\newcommand{\mdrd}{test_1d-depth-5}
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_raw_data} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_all}
\end{tabular}
...
\begin{itemize}
  ...
  \item \input{test_1d-depth-5/test_1d-depth-5_1_short_description.tex} 

  \item \input{test_1d-depth-5/test_1d-depth-5_2_short_description.tex} 

  \item \input{test_1d-depth-5/test_1d-depth-5_3_short_description.tex} 
...
\input{test_1d-depth-5/test_1d-depth-5_1_description.tex}
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_1} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_1_cum}
\end{tabular}
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_1_anti_cum}
\end{tabular}
...
\input{test_1d-depth-5/test_1d-depth-5_2_description.tex}
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_2} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_2_cum}
\end{tabular}
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_2_anti_cum}
\end{tabular}
...
\input{test_1d-depth-5/test_1d-depth-5_3_description.tex}
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_3} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_3_cum}
\end{tabular}
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_all} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_all_sample}
\end{tabular}
...
\input{test_1d-depth-5/test_1d-depth-5_1_extrap_description.tex}
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_1_extrap} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_1_sample} \\
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_1_cum_extrap} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_1_cum_sample}
\end{tabular}
...
\input{test_1d-depth-5/test_1d-depth-5_2_extrap_description.tex}
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_2_extrap} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_2_sample} \\
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_2_cum_extrap} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_2_cum_sample}
\end{tabular}
...
\input{test_1d-depth-5/test_1d-depth-5_3_extrap_description.tex}
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_3_extrap} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_3_sample} \\
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_3_cum_extrap} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_3_cum_sample}
\end{tabular}
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_acf_bands_1} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_pxx_bands_1} \\
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_qq_bands_1}
\end{tabular}
\caption{
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_acf_bands_2} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_pxx_bands_2} \\
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_qq_bands_2}
\end{tabular}
\caption{
ACF (top left), periodogram (top right) and quantile-quantile (bottom left) uncertainty plots.
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_acf_bands_3} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_pxx_bands_3} \\
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_qq_bands_3}
\end{tabular}
\caption{
ACF (top left), periodogram (top right) and quantile-quantile (bottom left) uncertainty plots.
...
\newcommand{\mdrd}{test_1d-depth-5}
\newcommand{\mbm}{\hspace{-0.3cm}}
\includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_mmd_1}
\caption{
MMD plot}
\label{fig:mmd1}
\end{figure}
...
\newcommand{\mdrd}{test_1d-depth-5}
\newcommand{\mbm}{\hspace{-0.3cm}}
\includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_mmd_2}
\caption{
MMD plot}
\label{fig:mmd2}
\end{figure}
...
\newcommand{\mdrd}{test_1d-depth-5}
\newcommand{\mbm}{\hspace{-0.3cm}}
\includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-5_mmd_3}
\caption{
MMD plot}
\label{fig:mmd3}
\end{figure}
