...
\title{An automatic report for the dataset : test_1d-depth-2}
...
\newcommand{\mdrd}{test_1d-depth-2}
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_raw_data} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_all}
\end{tabular}
...
\begin{itemize}
  ...
  \item \input{test_1d-depth-2/test_1d-depth-2_1_short_description.tex} 

  \item \input{test_1d-depth-2/test_1d-depth-2_2_short_description.tex} 

  \item \input{test_1d-depth-2/test_1d-depth-2_3_short_description.tex} 

  \item \input{test_1d-depth-2/test_1d-depth-2_4_short_description.tex} 
...
\input{test_1d-depth-2/test_1d-depth-2_1_description.tex}
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_1} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_1_cum}
\end{tabular}
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_1_anti_cum}
\end{tabular}
...
\input{test_1d-depth-2/test_1d-depth-2_2_description.tex}
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_2} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_2_cum}
\end{tabular}
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_2_anti_cum}
\end{tabular}
...
\input{test_1d-depth-2/test_1d-depth-2_3_description.tex}
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_3} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_3_cum}
\end{tabular}
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_3_anti_cum}
\end{tabular}
\caption{Pointwise posterior of residuals after adding component 3}
\label{fig:comp3}
\end{figure}

\subsection{Component 4 : Uncorrelated noise. This function applies from  391 onwards}

\input{test_1d-depth-2/test_1d-depth-2_4_description.tex}
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_4} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_4_cum}
\end{tabular}
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_all} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_all_sample}
\end{tabular}
...
\input{test_1d-depth-2/test_1d-depth-2_1_extrap_description.tex}
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_1_extrap} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_1_sample} \\
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_1_cum_extrap} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_1_cum_sample}
\end{tabular}
...
\input{test_1d-depth-2/test_1d-depth-2_2_extrap_description.tex}
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_2_extrap} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_2_sample} \\
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_2_cum_extrap} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_2_cum_sample}
\end{tabular}
...
\input{test_1d-depth-2/test_1d-depth-2_3_extrap_description.tex}
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_3_extrap} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_3_sample} \\
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_3_cum_extrap} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_3_cum_sample}
\end{tabular}
...
\input{test_1d-depth-2/test_1d-depth-2_4_extrap_description.tex}
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_4_extrap} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_4_sample} \\
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_4_cum_extrap} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_4_cum_sample}
\end{tabular}
...
2 & \textcolor{gray}{0.795} & \textcolor{gray}{0.085} & \textcolor{gray}{0.338} & \textcolor{gray}{0.425} & \textcolor{gray}{0.725} & \textcolor{gray}{0.455}\\
...
4 & \textcolor{gray}{0.486} & \textcolor{gray}{0.509} & \textcolor{gray}{0.494} & \textcolor{gray}{0.509} & \textcolor{gray}{0.522} & \textcolor{gray}{0.486}\\
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_acf_bands_1} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_pxx_bands_1} \\
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_qq_bands_1}
\end{tabular}
\caption{
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_acf_bands_2} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_pxx_bands_2} \\
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_qq_bands_2}
\end{tabular}
\caption{
ACF (top left), periodogram (top right) and quantile-quantile (bottom left) uncertainty plots.
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_acf_bands_3} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_pxx_bands_3} \\
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_qq_bands_3}
\end{tabular}
\caption{
ACF (top left), periodogram (top right) and quantile-quantile (bottom left) uncertainty plots.
...
\subsubsection{Component 4 : Uncorrelated noise. This function applies from  391 onwards}
...
\newcommand{\mbm}{\hspace{-0.3cm}}
\begin{tabular}{cc}
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_acf_bands_4} & \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_pxx_bands_4} \\
\mbm \includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_qq_bands_4}
\end{tabular}
\caption{
ACF (top left), periodogram (top right) and quantile-quantile (bottom left) uncertainty plots.
...
\newcommand{\mdrd}{test_1d-depth-2}
\newcommand{\mbm}{\hspace{-0.3cm}}
\includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_mmd_1}
\caption{
MMD plot}
\label{fig:mmd1}
\end{figure}
...
\newcommand{\mdrd}{test_1d-depth-2}
\newcommand{\mbm}{\hspace{-0.3cm}}
\includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_mmd_2}
\caption{
MMD plot}
\label{fig:mmd2}
\end{figure}
...
\newcommand{\mdrd}{test_1d-depth-2}
\newcommand{\mbm}{\hspace{-0.3cm}}
\includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_mmd_3}
\caption{
MMD plot}
\label{fig:mmd3}
\end{figure}
...
\newcommand{\mdrd}{test_1d-depth-2}
\newcommand{\mbm}{\hspace{-0.3cm}}
\includegraphics[width=\wmgd,height=\hmgd]{\mdrd/test_1d-depth-2_mmd_4}
\caption{
MMD plot}
\label{fig:mmd4}
\end{figure}
